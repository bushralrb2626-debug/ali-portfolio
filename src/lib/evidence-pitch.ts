...
/** Named public logos / case studies — not a market-share study. No vendor brand labels. */
export const CHART_HOST_LOGOS: PitchChart = {
  type: "bar",
  title: "Named public company stories (sample)",
  caption:
    "Count of named logos on hosted platforms: Washington Post, eBay, Sonos, Box, Runway, HashiCorp on the edge host side; Mozilla, GitHub, 1Password, Pika on the data side. DIY kits are built for one retailer farm. Not a market-share report.",
  kind: "model",
  bars: [
    { label: "Hosted edge", value: 6, suffix: " names" },
    { label: "Hosted data", value: 4, suffix: " names" },
    { label: "DIY kit", value: 1, suffix: " (in-house)" },
  ],
};
...
export const CHART_HOST_OPS: PitchChart = {
  ...
  caption:
    "A DIY kit is a scaffold — you still host servers, database, auth, files. Hosted edge + managed data is hosted. Not a published ops audit.",
  kind: "model",
  bars: [
    { label: "DIY kit", value: 4, suffix: " layers" },
    { label: "Hosted stack", value: 0, suffix: " extra" },
  ],
};
...
const DECKS: Record<string, PitchDeck> = {
  ...
  "stack-vercel-supabase": deck(
    ...
    "Hosted site + database, not a DIY farm",
    {
      title: "Big names already sit on hosted stacks",
      subtitle: "Named public stories — not a market-share study",
      accent: "win",
      bullets: [
        "Hosted edge case studies name The Washington Post, eBay, Sonos, Box, Runway, HashiCorp.",
        "Managed-data customer lists name Mozilla, GitHub, 1Password, Pika.",
        "A DIY kit is an open-source React/Node scaffold for huge in-house teams. You still run the servers and the database.",
        "A campus site needs a host and a database. Hosted edge + managed data is that pair. A DIY kit is not a host.",
      ],
    ...
    },
    {
      title: "What to say",
      bullets: [
        "Point at named public logos on hosted platforms. Do not invent a Fortune 500 percentage.",
        "DIY is a scaffold you operate. Hosted ships the site. Managed data holds the records.",
      ],
    },
  ),
  "why-vercel-supabase": deck(
    "why-vercel-supabase",
    "Hosted site + database over a DIY kit",
    {
      title: "Same stack the big sites already use",
      subtitle: "Host + database, not an in-house scaffold",
      accent: "win",
      bullets: [
        "Washington Post ran election night pages on a hosted edge. That is a named public story.",
        "Mozilla and GitHub show up on managed-data public customer lists.",
        "A DIY kit does not replace that. It is a React/Node toolkit. You still operate the farm.",
      ],
      charts: [CHART_HOST_LOGOS, CHART_HOST_OPS],
    },
    {
      title: "What to remember",
      bullets: [
        "Logos are from public vendor stories. The bar chart is a count of those names, not market share.",
      ],
    },
  ),
  "proj-meta": deck(
