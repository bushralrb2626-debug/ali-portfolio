...
const pairs = [
  ...
  ["A joyful place where children learn, explore, and grow — every single day.", "Un luogo gioioso dove i bambini imparano, esplorano e crescono — ogni singolo giorno."],
  ["School Life", "Vita scolastica"],
  ["Explore", "Esplora"],
  ["Visit", "Visita"],
  ["Welcome back", "Bentornati"],
  ["Authorized school staff and users only. Your dashboard opens based on your account.", "Solo personale e utenti autorizzati. La dashboard si apre in base al tuo account."],
  ["School Login", "Accesso scuola"],
  ["Enter your email and password. Role is determined from your account — not from this form.", "Inserisci email e password. Il ruolo dipende dal tuo account — non da questo modulo."],
  ...
  ["Scuola Materna campus", "Campus Scuola Materna"],
  ["Scuola Materna home", "Home Scuola Materna"],
