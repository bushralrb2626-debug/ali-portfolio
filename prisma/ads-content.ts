...
export const adsPortfolioSections: Prisma.SectionCreateManyInput[] = [
  {
    ...
    imageUrl: "/evidence/hero.jpg?v=2",
    items: "[]",
    sortOrder: 0,
    visible: true,
  },
  ...
  },
  {
    ...
    items: JSON.stringify([
      ...
      },
      {
        ...
        url: "/demos/brightsteps/",
        articleUrl: "/demos/brightsteps/",
        sourceLabel: "Open web",
        imageUrl: "/evidence/proj-brightsteps.jpg",
        videoUrl: "",
        whyAdded: "Ali’s BrightSteps school-platform demo. Opens as a live site, not a pitch film.",
        whyVideo: "None — open web.",
        whyArticle: "Open web live demo.",
        pitchLine: "BrightSteps Academy — live campus site and portals.",
        timeRange: "Open web — live demo",
      },
    ]),
    sortOrder: 4,
    visible: true,
    ...
    items: JSON.stringify([
      {
        ...
        title: "Elon Musk",
        description:
          "There is nothing AI cannot do better than humans, except be human. Digital jobs, including software, are already work AI does better than most engineers.",
        ...
        pitchLine: "AI is already better at the digital job.",
      ...
      },
      {
        ...
        description:
          "A mid-level engineer is an AI engineer. New applications are built by AI engineers, not by people in those seats.",
        url: "https://www.youtube.com/watch?v=7k1ehaE0bdU&t=7680",
        videoUrl: "https://www.youtube.com/watch?v=7k1ehaE0bdU&t=7680",
        sourceLabel: "Joe Rogan Experience #2255 — official",
        pitchLine: "The engineering seat is already an AI seat.",
      ...
      },
      {
        ...
        title: "Andy Jassy",
        description:
          "Agents already handle coding, research, and analytics. Those jobs need fewer people because the agent is doing the work.",
        ...
        pitchLine: "Agents do the job. Fewer people on that job.",
      ...
      },
      {
        ...
        title: "Bill Gates",
        description:
          "Asked if we still need humans: not for most things. Expert help becomes ordinary. Making, moving, and growing food become solved problems.",
        url: "https://www.youtube.com/watch?v=uHY5i9-0tJM&t=420",
        videoUrl: "https://www.youtube.com/watch?v=uHY5i9-0tJM&t=420",
        sourceLabel: "The Tonight Show Starring Jimmy Fallon — official NBC",
        pitchLine: "Humans are not needed for most things.",
        timeRange: "7:00–8:45",
      },
      {
        id: "why-amodei",
        title: "Dario Amodei",
        description:
          "Models already sit in the middle of entry-level office work — the college-student layer that writes reports and code. Half of those jobs can go. Machines can do pretty much everything better.",
        url: "https://www.youtube.com/watch?v=zju51INmW7U&t=36",
        videoUrl: "https://www.youtube.com/watch?v=zju51INmW7U&t=36",
        articleUrl:
          "https://www.cnn.com/2025/05/28/tech/ai-anthropic-ceo-dario-amodei-unemployment",
        sourceLabel: "CNN — Anderson Cooper, Amodei on camera",
        pitchLine: "Entry-level digital work is already the model’s job.",
        timeRange: "0:36–1:58 · 4:39–5:52 · 6:03–6:16",
      },
      {
        id: "why-hastings",
        title: "Reed Hastings",
        description:
          "AI getting twice as good each year is like doubling the workforce. A CEO can cut the workforce in half and still run the same business lines.",
        url: "https://www.semafor.com/article/08/13/2026/reed-hastings-ceo-signal",
        videoUrl:
        ...
        sourceLabel: "Semafor — The CEO Signal, Hastings speaking",
        pitchLine: "Same business with half the humans.",
        timeRange: "30:44–36:30",
      },
      {
        id: "why-saas",
        title: "Campus stack without a staff team",
        description:
          "The same idea on a campus: site, chatbot, ads, and inbox run as an AI stack. Those jobs do not need a human team on payroll.",
        url: "",
        videoUrl: "",
